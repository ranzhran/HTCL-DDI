...
from .data import DDIDatapoint, DDIDataset
...
def filter_invalid_smiles_ddi(data: DDIDataset) -> DDIDataset:
    return DDIDataset([datapoint for datapoint in data
                            if datapoint.smiles_1 != '' and datapoint.mol_1 is not None
                            and datapoint.smiles_2 != '' and datapoint.mol_2 is not None
                            and datapoint.mol_1.GetNumHeavyAtoms() > 0
                            and datapoint.mol_2.GetNumHeavyAtoms() > 0]
                      )
